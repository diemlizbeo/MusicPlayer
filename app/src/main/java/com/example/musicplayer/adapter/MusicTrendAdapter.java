...
public class MusicTrendAdapter extends RecyclerView.Adapter<MusicTrendAdapter.MusicViewHolder> {


    private Context context;
    public static ArrayList<MusicFile> listFile;

    public MusicTrendAdapter(Context context, ArrayList<MusicFile> listFile) {
    ...
    public void onBindViewHolder(@NonNull MusicViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("sender", "musicTrend");
